...
const GadgetsProducts = () => {
  ...
  useEffect(() => {
    ...
    fetch("/Product.json")
      ...
      .then((data) => {
        // Filter products where category is 'Gadget'
        const gadgetProducts = data.filter((product) => product.category.includes("Gadgets"));
  ...
  return (
    <div className="featured-products mx-auto w-[90%] lg:left-32 lg:right-32 px-4 mt-20">
      <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-center">Gadget</h1>
